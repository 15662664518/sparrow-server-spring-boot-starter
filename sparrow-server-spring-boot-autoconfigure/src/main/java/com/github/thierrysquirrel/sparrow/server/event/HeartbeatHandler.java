...
public class HeartbeatHandler {
    ...
    public void ping(ChannelHandlerContext ctx, SparrowRequestContext msg, String topic) {
        HeartbeatHandlerFactoryExecution.ping (ctx, administrationService, topic);
    }
