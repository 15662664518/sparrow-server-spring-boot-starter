...
/**
 * ClassName: SynchronizingHandlerFactory
 * Description:
 * date: 2020/6/9 4:41
 *
...
public class SynchronizingHandlerFactory {
    ...
    public static SparrowRequestContext synchronousClusterTopicCache(SparrowTopicEntityCacheTemplate sparrowTopicEntityCacheTemplate, String topic) {
