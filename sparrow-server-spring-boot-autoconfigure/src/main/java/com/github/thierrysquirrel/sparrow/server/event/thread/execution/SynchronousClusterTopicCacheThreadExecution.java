...
/**
 * ClassName: SynchronousClusterTopicCacheThreadExecution
 * Description:
 * date: 2020/6/9 4:11
 *
...
public class SynchronousClusterTopicCacheThreadExecution extends AbstractSynchronousClusterTopicCacheThread {
    ...
    public SynchronousClusterTopicCacheThreadExecution(String url, SparrowRequestContext sparrowRequestContext) {
        super (url, sparrowRequestContext);
    }

    @Override
    protected void synchronousClusterTopicCache(String url, SparrowRequestContext sparrowRequestContext) {
        try {
            ClientFactory.request (url, sparrowRequestContext);
        } catch (Exception e) {
