...
/**
 * ClassName: SparrowServerInitExecution
 * Description:
 * date: 2020/6/8 18:49
 *
...
public class SparrowServerInitExecution {
    ...
    public static void sparrowServerInit(SparrowServerProperties sparrowServerProperties) {
        ThreadPoolExecutor sparrowServerInitThreadPool = ThreadPoolFactory.createSparrowServerInitThreadPool ();
        String url = sparrowServerProperties.getUrl ();
        SparrowServerInitThreadExecution sparrowServerInitThreadExecution = new SparrowServerInitThreadExecution (url);
        ThreadPoolFactoryExecution.statsThreadAndShutdown (sparrowServerInitThreadPool, sparrowServerInitThreadExecution);
    }
}
