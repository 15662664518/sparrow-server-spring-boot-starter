...
/**
 * ClassName: CacheTemplateBuilder 
 * Description: 
 * date: 2020/6/9 2:51
 *
...
public class CacheTemplateBuilder {
    ...
    public static SparrowTopicEntityCacheTemplate builderSparrowTopicEntityCacheTemplate() {
        Cache<String, SparrowTopicEntity> sparrowTopicEntityCache = CaffeineBuilder.builderSparrowTopicEntityCache ();
        return new SparrowTopicEntityCacheTemplate (sparrowTopicEntityCache);
    }
}
