...
/**
 * ClassName: AbstractSparrowServerInitThread 
 * Description: 
 * date: 2020/6/8 18:38
 *
...
public abstract class AbstractSparrowServerInitThread implements Runnable {
    ...
    public AbstractSparrowServerInitThread(String sparrowServerUrl) {
     ...
     */
    protected abstract void sparrowServerInit(String sparrowServerUrl);
