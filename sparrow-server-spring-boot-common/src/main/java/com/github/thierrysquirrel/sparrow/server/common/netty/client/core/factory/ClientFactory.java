...
public class ClientFactory {
    ...
    public static SparrowRequestContext request(String url, SparrowRequestContext sparrowRequestContext) throws InterruptedException, TimeoutException, ExecutionException {
