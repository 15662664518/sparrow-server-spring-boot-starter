 ...
 * @since JDK 1.8
 */
public class SparrowEncode extends MessageToByteEncoder<SparrowRequestContext> {

    @Override
    protected void encode(ChannelHandlerContext ctx, SparrowRequestContext msg, ByteBuf out) {
        out.writeBytes (CodeIdentification.SPARROW.getValue ());
